(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnSave","405","76","71","25",null,null,null,null,null,null,this.divCommand.form);
            obj.set_taborder("20");
            obj.set_text("저장");
            this.divCommand.addChild(obj.name, obj);

            obj = new Button("btnInit","486","76","71","25",null,null,null,null,null,null,this.divCommand.form);
            obj.set_taborder("21");
            obj.set_text("초기화");
            this.divCommand.addChild(obj.name, obj);
        ...
        */
        ...
        {
        	var search = this.divCommand.form.edtSearch.value;
        	trace("[search]" + search);

        	 var id = "search";
             //  var url = "http://localhost:8088/HelloMx/Services/sample.xml";
        	 //  var url = "JPSvc::sample.xml";
        	 var url = "JPSvc::search.jsp";
             var reqDs = "";
        ...
        //  초기화
        this.divCommand_btnInit_onclick = function(obj,e)
        {
        	 var id = "initdate";
        	 var url = "JPSvc::initdata.jsp";
             var reqDs = "";
             var respDs = "";
             var args = "";
             var callback = "svcCallbackFunc";
         ...
         // 저장
        this.divCommand_btnSave_onclick = function(obj,e)
        {
        	 trace("[savelist]");

        	 var id = "savelist";
        	 var url = "JPSvc::savelist.jsp";
        ...
        this.on_initEvent = function()
        {
            ...
            this.divCommand.form.btnSave.addEventHandler("onclick",this.divCommand_btnSave_onclick,this);
            this.divCommand.form.btnInit.addEventHandler("onclick",this.divCommand_btnInit_onclick,this);
