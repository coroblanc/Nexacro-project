(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"84\"/><Column size=\"84\"/><Column size=\"84\"/><Column size=\"117\"/><Column size=\"86\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"선택\"/><Cell col=\"1\" text=\"아이디\"/><Cell col=\"2\" text=\"이름\"/><Cell col=\"3\" text=\"비밀번호\"/><Cell col=\"4\" text=\"전자메일\"/><Cell col=\"5\" text=\"성별\"/></Band><Band id=\"body\"><Cell text=\"bind:CHECK\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"bind:MID\"/><Cell col=\"2\" text=\"bind:MNAME\"/><Cell col=\"3\" text=\"bind:PWD\"/><Cell col=\"4\" text=\"bind:EMAIL\"/><Cell col=\"5\" text=\"bind:GENDER\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnInsert","547","34","86","26",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("입력");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnDelete","647","34","86","26",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("삭제");
            this.addChild(obj.name, obj);

            obj = new Button("btnSave","744","34","86","26",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("저장");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("Members2.xfdl", function() {
        ...
        {
        		for(var row = 0; row < this.ds_member.getRowCount();){
        			var check = this.ds_member.getColumn(row, "CHECK");
        			trace("DEL : count=" + this.ds_member.getRowCount() + ", row=" + row + ", check=" + check);
        			if(check !== undefined && check !== null && check ==1) {
        				this.ds_member.deleteRow(row);
        			}
        			else{
        			row++;
        			}
        ...
        {
        	 var svcid = "members";
             var url = "http://localhost:8088/HelloMx/Services/membersvc.jsp";
             var reqDs = "member=ds_member:U"; // U(Update), 갱신된 정보만 전송
             var respDs = "";
             var args = "";
             var callback = "CallbackFunc";

             this.transaction(svcid, url, reqDs, respDs, args, callback);
        };

        this.CallbackFunc = function(svcid, code, message)
        {
        	trace("[" + svcid + "]");
             if (code == 0) {
                  this.alert(this.ds_member.rowcount + " numbers of data have been found.");
                  trace(this.ds_member.rowcount + " numbers of data have been found.");
             } else {
        ...
        this.loadIncludeScript("Members2.xfdl");
