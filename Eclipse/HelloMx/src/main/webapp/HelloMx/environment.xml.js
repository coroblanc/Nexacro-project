if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("JPSvc", "JSP", "http://localhost:8088/HelloMx/Services/", "session", null, "", "0", "0");
        nexacro._addService("MXSvc", "JSP", "http://localhost:8088/HelloMx/MXServices/", "session", null, "", "0", "0");
